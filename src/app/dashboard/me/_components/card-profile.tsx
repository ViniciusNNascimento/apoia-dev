...
export function CardProfile({ user }: CardProfileProps) {
    return (
        <section className="w-full flex  flex-col items-center mx-auto px-4">
            <div className="">
                <Image
                    src={user.image ?? "https://github.com/ViniciusNNAscimento.png"}
                    alt="Foto de Perfil"
                    width={104}
                    height={104}
                    className="bg-gray-50 object-cover border-4 rounded-xl border-white hover:shadow-xl duration-300"
                    priority
                    quality={100}
                />
            </div>
