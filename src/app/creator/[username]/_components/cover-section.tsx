...
export function CoverSection({ coverImage, name, profileImage }: CoverSectionProps) {
    return (
        <div className="relative h-48 w-full sm:h-64 md:h-80">
            ...
            <div className="absolute bottom-2 md:bottom-6 left-0 right-0 p-4 md:p-8">
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="flex flex-col items-center sm:items-end sm:flex-row sm:gap-6 gap-4">
                        <div className="relative flex-shrink-0">
                            <Avatar className="h-20 w-20 border-2 md:border-4 sm:w-24 sm:h-24 md:w-32 md:h-32 shadow-2xl group">
                                <AvatarImage
